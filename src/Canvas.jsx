...
class Canvas extends React.Component {  
  ...
  render() {    
    return <div id="canvas">
      ...
      <button className="canvasHeader" id="downloadbutton" type="button" onClick={downloadAsJson.bind(this, "download.json", this.state.data)}><i className="fa-solid fa-download"></i> Exporteer Canvas</button>
      <input type="file" id="canvasUpload" style={{display: "none"}} onChange={this.importCanvas.bind(this)} accept="application/json"/> 
      <button className="canvasHeader" id="uploadbutton" type="button" onClick={this.uploadCanvas.bind(this)}><i className="fa-solid fa-upload"></i> Importeer Bestand/Canvas</button>
      </div>
